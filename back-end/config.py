...
class Config:
    ...
    IMG_SIZE = (128, 128)  # Corrected input size expected by the model

# Option 1: Add "Unknown" as the 118th class
CLASSES = [
...
'Turmeric leaf', 'White musalli', 'Wood_sorel plant', 'Unknown'  # Added "Unknown" as the 118th class
]

# Option 2: Handle the class mismatch in your prediction service (see updated prediction_service.py)
